    ...
    <div class="nav-content flex justify-between">
        ...
        <div id="content" class="flex flex-col h-screen w-8/12 fixed ml-96">
            <div class="p-2 ">
                ...
                @endif
                <form action="{{ route('add-detail-data-barang') }}" method="POST">
                    @csrf
                    ...
                    <div class="text-right">
                        <a href="{{ route('detail-f&d') }}" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-2 focus:ring-offset-2 cursor-pointer">Cancel</a>
