...
<body class="h-screen bg-sky-500">
    <div class="flex h-full">
        ...
        <div class="flex-1 bg-sky-500 text-white flex flex-col justify-center items-center p-8">
            <img src="{{ asset('SMK_Negeri_1_Bantul_logo.png') }}" alt="Logo Sekolah" class="w-32 h-auto mb-4">
            <h1 class="text-4xl font-bold">SMK NEGERI 1 BANTUL</h1>
            <h2 class="text-3xl font-semibold mt-2">CAFETARIA APP</h2>
        </div>
        ...
        <div class="flex-1 bg-gray-100 flex justify-center items-center p-8">
            <div class="w-full max-w-md">
                ...
                <div class="text-right mb-4">
                    <a href="{{ route('login') }}" class="border border-slate-900 rounded-lg p-2 hover:border-slate-400">
                        Login
                    </a>
                </div>
