    ...
    <div class="flex nav-content">
        ...
        <div class="ml-80 w-3/4 p-10 fixed">
            ...
            <div class="mb-4 flex justify-end">
                <button class="bg-blue-500 text-white px-2 py-2 rounded ml-auto ">Add Product</button>
            </div>
                ...
                <table class="w-full bg-white border">
                    <thead>
                        <tr>
                            ...
                            <th class="px-6 py-3 border-b-2 border-gray-300 text-center text-sm font-semibold text-gray-600">Aksi</th>
                        </tr>
                        </thead>
        </div>
    </div>
