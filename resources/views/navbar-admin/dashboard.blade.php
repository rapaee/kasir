...
<body>
    <div class="flex">
        ...
        <nav class="bg-sky-400 w-96 h-screen fixed">
            ...
            <ul class="">
                <div class="flex z-10 items-center p-10 bg-sky-500 hover:bg-sky-300 hover-transition cursor-pointer" onclick="window.location='{{ route('admin.home') }}'">
                ...
                <div class="flex items-center p-10 hover:bg-sky-300 cursor-pointer" onclick="window.location='{{ route('data-barang-admin') }}'">
                ...
                <div class="flex items-center p-10 hover:bg-sky-300 cursor-pointer" onclick="window.location='{{ route('transaksi-admin') }}'">
                ...
                <div class="flex items-center p-10  hover:bg-sky-300 cursor-pointer" onclick="window.location='{{ route('laporan-keuangan-admin') }}'">
